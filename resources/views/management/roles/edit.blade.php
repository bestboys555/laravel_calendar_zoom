        ...
        <div class="card">
            <div class="card-body">
                ...
                <div class="form-group">
                    ...
                    <div class="form-radio">
                        <div class="radio radio-outline radio-inline">
                            <label>
                                <input type="radio" name="show_all_data" value="1" {!! (old('show_all_data')=='1' or $role->show_all_data == '1') ? 'checked="checked"' : '' !!}>
                                <i class="helper"></i>Manage data from all user
                            </label>
                        </div>
                        <div class="radio radio-outline radio-inline">
                            <label>
                                <input type="radio" name="show_all_data" value="0" {!! (old('show_all_data')=='0' or $role->show_all_data == '0') ? 'checked="checked"' : '' !!}>
                ...
                <div class="form-group">
                    ...
                    <div class="">
                        {!! Form::checkbox('publish', '1', old('publish', $role->publish), ['class' => 'js-dynamic-state']); !!}
                    </div>
                </div>
