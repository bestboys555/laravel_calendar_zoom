            ...
            <div class="card-body">
                <form class="form-horizontal" action="{{ route('profile.UpdatePass') }}" method="POST">
                    ...
                    <div class="form-group row">
                        <label for="exampleInputPassword2" class="col-sm-3 col-form-label">Old password <small class="color-red">*</small></label>
                        <div class="col-sm-9">
                    ...
                    <div class="form-group row">
                        <label for="exampleInputPassword2" class="col-sm-3 col-form-label">New password <small class="color-red">*</small></label>
                        <div class="col-sm-9">
                    ...
                    <div class="form-group row">
                        <label for="exampleInputConfirmPassword2" class="col-sm-3 col-form-label">Re Password <small class="color-red">*</small></label>
                        <div class="col-sm-9">
