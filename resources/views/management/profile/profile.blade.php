        ...
        <div class="card">
            <div class="card-body">
                <div class="text-center">
                    <img src="{!! user_photo(Auth::user()->id) !!}" class="rounded-circle" width="150">
            ...
            <div class="card-body">
                <form class="form-horizontal" action="{{ route('profile.updateAuthUser') }}" method="POST">
                    ...
                    <div class="form-group">
                        <label for="example-name">Full Name <small class="color-red">*</small></label>
                        {!! Form::text('name', old('name', $profile->name), array('id'=>'name','placeholder' => 'Full Name','class' => 'form-control','required' => 'required')) !!}
                    </div>
                    <div class="form-group">
                        <label for="example-name">Tell <small class="color-red">*</small></label>
                        {!! Form::text('tell', old('tell', $profile->tell), array('id'=>'tell','placeholder' => 'Tell','class' => 'form-control')) !!}
                    </div>
                    <div class="form-group">
                        <label for="example-name">Address <small class="color-red">*</small></label>
                        {!! Form::textarea('address', old('address', $profile->address), array('id'=>'address','placeholder' => 'Address','class' => 'form-control')) !!}
                    </div>
