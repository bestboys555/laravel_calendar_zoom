    ...
    <div class="col-lg-12">
        <div class="card">
                    ...
                    <div class="col-md-3"><div class="text-left">
                        ...
                        <div class="input-group">
                            ...
                            <div class="input-group-append">
                              <button class="btn btn-outline-secondary" type="submit"><i class="ik ik-search"></i> Search</button>
                            </div>
                          </div>
                          {!! Form::close() !!}

                    </div></div>
                    <div class="col-md-9">@can('user-create')
            ...
            <div class="card-body template-demo">
                <a href="{{ route('users.export_excel') }}" class="btn btn-primary">Export to Excel</a>
            </div>
                ...
                <div class="table-responsive">
                    ...
                    <tbody>
                        @foreach ($data as $key => $user)
                         <tr>
                           <td>{{ ++$i }}</td>
                           <td><img src="{!! user_photo($user->id) !!}" class="rounded-circle" width="50"></td>
                           <td>{{ $user->name }}</td>
                           <td>{{ $user->email }}</td>
                           <td>
