        ...
        {!! Form::open(array('route' => 'users.store','method'=>'POST')) !!}
            ...
            <div class="card">
                <div class="card-body">
                    ...
                    <div class="form-group">
                        <label for="email">Email <small class="color-red">*</small></label>
                        {!! Form::text('email', old('email',null), array('id'=>'email','placeholder' => 'Email','class' => 'form-control','required' => 'required')) !!}
                    </div>
                    <div class="form-group">
                        <label for="password">Password <small class="color-red">*</small></label>
                        {!! Form::password('password', array('placeholder' => 'Password','class' => 'form-control','required' => 'required')) !!}
                    </div>
                    <div class="form-group">
                        <label for="confirm-password">Confirm Password <small class="color-red">*</small></label>
